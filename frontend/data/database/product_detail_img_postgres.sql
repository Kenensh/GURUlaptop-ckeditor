-- PostgreSQL version of product_detail_img.sql
-- Converted from MySQL on 2025-06-18 11:03:55
-- Table: product_detail_img

-- 如果表格已存在則刪除
DROP TABLE IF EXISTS public.product_detail_img CASCADE;
...
-- 如果表格已存在則刪除
DROP TABLE IF EXISTS "product_detail_img" CASCADE;

CREATE TABLE "product_detail_img" (
  "id" INTEGER(10) NOT NULL,
  "img_product_id" INTEGER(10) NOT NULL,
...
--
-- 使用資料表自動遞增() "product_detail_img"
--
ALTER TABLE "product_detail_img"
  MODIFY "id" INTEGER(10) NOT NULL , =833;
COMMIT;
